...
class EmailService
{
    ...
    {
        try {
            $tenantId = config('services.microsoft_email.tenant_id');
            $clientId = config('services.microsoft_email.client_id');
            $clientSecret = config('services.microsoft_email.client_secret');
    ...
    {
        try {
            $senderEmail = config('services.microsoft_email.noreply_email', 'noreply@finfinity.co.in');
            $senderName = config('app.name', 'FinFinity Portal');
